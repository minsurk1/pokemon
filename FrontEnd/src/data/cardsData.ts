// FrontEnd/src/data/cardsData.ts
...
export const cardsData = {
  ...
  fly: [flyTier1, flyTier2, flyTier3, flyTier4, flyTier5, flyTier6, flyTier7],
  ice: [iceTier1, iceTier2, iceTier3, iceTier4, iceTier5, iceTier6, iceTier7],
  land: [
    landTier1,
    landTier2,
    landTier3,
...
export function getCardImageByNameAndTier(
  ...
  if (tier < 1 || tier > cardArray.length) {
    console.warn(`${tier} 티어는 범위를 벗어났습니다.`);
    return placeholderImg;
  }
